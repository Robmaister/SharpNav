...
namespace SharpNav
{
    ...
    public class Heightfield : IEnumerable<Heightfield.Cell>
    {
        ...
        /// Area id constants
        /// </summary>
        public const byte AREA_NULL = 0;
        public const byte AREA_WALKABLE = 63;
        ...
        public void filterLowHangingWalkableObstacles(int walkableClimb)
        {
            for (int y = 0; y < length; ++y)
            {
                ...
                {
                    Span previousSpan = new Span(0, 0);
                    bool previousWalkable = false;
                    byte previousArea = AREA_NULL;
                    ...
                    for (int i = 0; i < spans.Count; i++)
                    {
                        ...
                        bool walkable;
                        walkable = (currentSpan.Area != AREA_NULL);
        ...
        /// <returns></returns>
        public int getDirOffsetX(int dir)
        {
            int [] offset = { -1, 0, 1, 0 };
            return offset[dir % 4];
        }
        ...
        /// <param name="dir">direction</param>
        /// <returns></returns>
        public int getDirOffsetY(int dir)
        {
            int [] offset = { 0, 1, 0, -1 };
            return offset[dir % 4];
        }
